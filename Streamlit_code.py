...
if Choice == 'Affordable':
    ...
    custom_labels = {"D": "Detached", "F": "Flats/Maisonettes", "T": "Terraced", "S": "Semi-Detached", "O": "Other"}
    trace61 = go.Line(x=[custom_labels[val] for val in dataset61['Property_Type']], y=dataset61['DVlog'], name="Actual Price", mode='lines', marker=dict(color='drak green'), showlegend=True)
    ...
    trace74 = go.Line(x=[custom_labels[val] for val in dataset71['New_Property']], y=dataset71['y_pred_RF_AM'], name='Random Forest', mode='lines',marker=dict(color='yellowgreen'), showlegend=True)
    ...
    Chart7_1 = go.Figure(data=[trace71, trace72, trace73, trace74, trace76, trace77, trace78, trace79], layout=layout)
    ...
    trace84 = go.Line(x=[custom_labels[val] for val in dataset81['Duration_Relates_to_the_tenure']], y=dataset81['y_pred_RF_AM'], name='Random Forest', mode='lines',marker=dict(color='yellowgreen'), showlegend=True)
    ...
    Chart8_1 = go.Figure(data=[trace81, trace82, trace83, trace84, trace86, trace87, trace88, trace89], layout=layout)
    ...
    trace94 = go.Line(x=dataset91['MonthYear'], y=dataset91['y_pred_RF_AM'], name='Random Forest', mode='lines',marker=dict(color='yellowgreen'), showlegend=True)
    ...
    Chart9_1 = go.Figure(data=[trace91, trace92, trace93, trace94, trace96, trace97, trace98, trace99], layout=layout)
    ...
    trace64 = go.Line(x=[custom_labels[val] for val in dataset61['Property_Type']], y=dataset61['y_pred_RF_MM'], name='Random Forest', mode='lines',marker=dict(color='yellowgreen'), showlegend=True)
    ...
    trace74 = go.Line(x=[custom_labels[val] for val in dataset71['New_Property']], y=dataset71['y_pred_RF_MM'], name='Random Forest', mode='lines',marker=dict(color='yellowgreen'), showlegend=True)
    ...
    trace84 = go.Line(x=[custom_labels[val] for val in dataset81['Duration_Relates_to_the_tenure']], y=dataset81['y_pred_RF_MM'], name='Random Forest', mode='lines',marker=dict(color='yellowgreen'), showlegend=True)
    ...
    trace94 = go.Line(x=dataset91['MonthYear'], y=dataset91['y_pred_RF_MM'], name='Random Forest', mode='lines',marker=dict(color='yellowgreen'), showlegend=True)
    ...
    trace64 = go.Line(x=[custom_labels[val] for val in dataset61['Property_Type']], y=dataset61['y_pred_RF_LM'], name='Random Forest', mode='lines',marker=dict(color='yellowgreen'), showlegend=True)
    ...
    trace74 = go.Line(x=[custom_labels[val] for val in dataset71['New_Property']], y=dataset71['y_pred_RF_LM'], name='Random Forest', mode='lines',marker=dict(color='yellowgreen'), showlegend=True)
    ...
    trace84 = go.Line(x=[custom_labels[val] for val in dataset81['Duration_Relates_to_the_tenure']], y=dataset81['y_pred_RF_LM'], name='Random Forest', mode='lines',marker=dict(color='yellowgreen'), showlegend=True)
    ...
    trace94 = go.Line(x=dataset91['MonthYear'], y=dataset91['y_pred_RF_LM'], name='Random Forest', mode='lines',marker=dict(color='yellowgreen'), showlegend=True)
